...
goog.exportSymbol('proto.CustomProtocol.S2CFrame', null, global);
 ...
 * @constructor
 */
proto.CustomProtocol.S2CFrame = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.CustomProtocol.S2CFrame.repeatedFields_, null);
};
goog.inherits(proto.CustomProtocol.S2CFrame, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.CustomProtocol.S2CFrame.displayName = 'proto.CustomProtocol.S2CFrame';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.CustomProtocol.S2CFrame.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.CustomProtocol.S2CFrame.prototype.toObject = function(opt_includeInstance) {
  return proto.CustomProtocol.S2CFrame.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.CustomProtocol.S2CFrame} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.CustomProtocol.S2CFrame.toObject = function(includeInstance, msg) {
  var f, obj = {
    framelistList: jspb.Message.toObjectList(msg.getFramelistList(),
    proto.CustomProtocol.C2SPlayerInput.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.CustomProtocol.S2CFrame}
 */
proto.CustomProtocol.S2CFrame.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.CustomProtocol.S2CFrame;
  return proto.CustomProtocol.S2CFrame.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.CustomProtocol.S2CFrame} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.CustomProtocol.S2CFrame}
 */
proto.CustomProtocol.S2CFrame.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.CustomProtocol.C2SPlayerInput;
      reader.readMessage(value,proto.CustomProtocol.C2SPlayerInput.deserializeBinaryFromReader);
      msg.addFramelist(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.CustomProtocol.S2CFrame.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.CustomProtocol.S2CFrame.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.CustomProtocol.S2CFrame} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.CustomProtocol.S2CFrame.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFramelistList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.CustomProtocol.C2SPlayerInput.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array.<!proto.CustomProtocol.C2SPlayerInput>}
 */
proto.CustomProtocol.S2CFrame.prototype.getFramelistList = function() {
  return /** @type{!Array.<!proto.CustomProtocol.C2SPlayerInput>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.CustomProtocol.C2SPlayerInput, 1));
};


/** @param {!Array.<!proto.CustomProtocol.C2SPlayerInput>} value */
proto.CustomProtocol.S2CFrame.prototype.setFramelistList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.CustomProtocol.C2SPlayerInput=} opt_value
 * @param {number=} opt_index
 * @return {!proto.CustomProtocol.C2SPlayerInput}
 */
proto.CustomProtocol.S2CFrame.prototype.addFramelist = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.CustomProtocol.C2SPlayerInput, opt_index);
};


proto.CustomProtocol.S2CFrame.prototype.clearFramelistList = function() {
  this.setFramelistList([]);
};
